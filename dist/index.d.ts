...
import { WamBinaryData, WamDescriptor, WamEvent, WamEventType, WamGroup as IWamGroup, WamMidiData, WamNode as IWamNode, WamParameter, WamParameterData, WamParameterDataMap, WamParameterInfo, WamParameterInfoMap, WamParameterMap, WamProcessor as IWamProcessor, WamTransportData, WebAudioModule as IWebAudioModule } from '@webaudiomodules/api';
...
export declare const getRingBuffer: (moduleId?: string) => typeof RingBuffer;
export declare const getWamArrayRingBuffer: (moduleId?: string) => typeof WamArrayRingBuffer;
export declare const initializeWamEnv: (apiVersion: string) => void;
export declare const initializeWamGroup: (groupId: string, groupKey: string) => void;
export declare const getWamEventRingBuffer: (moduleId?: string) => typeof WamEventRingBuffer;
export declare const getWamParameter: (moduleId?: string) => typeof WamParameter;
export declare const getWamParameterInfo: (moduleId?: string) => typeof WamParameterInfo;
export declare const getWamParameterInterpolator: (moduleId?: string) => typeof WamParameterInterpolator;
export declare const getWamProcessor: (moduleId?: string, dependencies?: {
	RingBuffer: string;
	WamEventRingBuffer: string;
	WamParameter: string;
	WamParameterInterpolator: string;
}) => typeof WamProcessor;
export declare const addFunctionModule: <F extends (...args: any[]) => any = (...args: any[]) => any>(audioWorklet: AudioWorklet, processorFunction: F, ...injection: Parameters<F>) => Promise<void>;
 ...
 */
export declare const initializeWamHost: (audioContext: BaseAudioContext, groupId?: string, groupKey?: string) => Promise<[
	string,
	string
]>;
